...
\n\
        function off() {\n\
            return request('OFF?text=aus')\n\
        }\n\
\n\
        function rr() {\n\
            return request('RR?text=rot-rot')\n\
        }\n\
\n\
        function rg() {\n\
...
\n\
        function ry() {\n\
            return request('RY?text=rot-gelb')\n\
        }\n\
\n\
        function gr() {\n\
...
\n\
        function yr() {\n\
            return request('YR?text=gelb-rot')\n\
        }\n\
\n\
        function yg() {\n\
...
\n\
        function yy() {\n\
            return request('YY?text=gelb-gelb')\n\
        }\n\
    </script>\n\
</head>\n\
\n\
